...
$result = $conn->query(" select vitesse, created_at from vitesse where train='Train 1' order by id desc limit 50");
    ...
    <div class="container text-center">
      ...
      <div class="row justify-content-center">
        <div class="col-6 my-3">
            ...
            <li class="nav-item">
              <a class="nav-link btn btn-success" href="historique_vit.php">HIstorique Vitesse</a>
            </li>
            <li class="nav-item">
          ...
          <ul class="nav nav-pills nav-fill bg-primary my-5">
            <li class="nav-item">
              <a class="nav-link btn btn-success" href="historique_vit.php">Train 1</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white" href="historique_arret.php">Train 2</a>
            </li>
          </ul>
